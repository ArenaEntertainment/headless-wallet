...
// Note: Vue plugin currently only supports one wallet config at a time
...
// To demonstrate multiple wallets in Vue, we need to inject the additional wallets directly
if (typeof window !== 'undefined') {
  ...
  console.log('🎮 Multiple wallets injected: Arena Wallet (via Vue plugin), Test Wallet, Dev Wallet')
}

const app = createApp(App)

app.use(router)
app.use(HeadlessWalletPlugin, primaryWalletConfig)
