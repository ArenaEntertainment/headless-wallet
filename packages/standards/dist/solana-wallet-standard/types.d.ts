...
export interface SolanaEvents extends WalletFeature {
    ...
    on<T extends keyof SolanaWalletEvents>(event: T, listener: SolanaWalletEvents[T], options?: {
        once?: boolean;
    }): () => void;
}
/**
...
export interface SolanaSignTransaction extends WalletFeature {
    ...
    signTransaction<T extends SolanaTransaction>(inputs: Array<{
...
export interface SolanaSignAndSendTransaction extends WalletFeature {
    ...
    signAndSendTransaction<T extends SolanaTransaction>(inputs: Array<{
        account: WalletAccount;
        transaction: T;
        chain?: string;
        options?: {
 ...
 */
export declare class MockSolanaTransaction implements SolanaTransaction {
    private data;
    private signatures;
...
export declare const SolanaChains: {
    ...
    readonly LOCALNET: "solana:localnet";
};
...
export declare const FeatureNames: {
    readonly STANDARD_CONNECT: "standard:connect";
    readonly STANDARD_DISCONNECT: "standard:disconnect";
    readonly STANDARD_EVENTS: "standard:events";
    readonly SOLANA_SIGN_TRANSACTION: "solana:signTransaction";
    readonly SOLANA_SIGN_MESSAGE: "solana:signMessage";
    readonly SOLANA_SIGN_AND_SEND_TRANSACTION: "solana:signAndSendTransaction";
};
